...
3. Wait a few minutes for the web to be deployed. It will be available at: `https://{github-username}.github.io/{repository-name}/{location-inside-repository}`. In this case: `https://egubaidullin.github.io/telegram-web-app-bot-example/index.html`
...
1. Show the user a special menu button (near the message input field):
    ...
    4. Send a URL to your Web App (in this case, `https://egubaidullin.github.io/telegram-web-app-bot-example/index.html`)
...
2. The second way is to send a button with the data that contains field `web_app` with a URL to a Web App:
    ```json
    {
        "text": "Test web_app",
        "web_app": {
            "url": "https://egubaidullin.github.io/telegram-web-app-bot-example/index.html"
        }
    }
    ```
